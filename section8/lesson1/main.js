...
app.controller('PersonDetailController', function ($scope, ContactService, $state, $stateParams) {
	$scope.mode = "Edit"
	$scope.contacts = ContactService;
	$scope.contacts.getPerson($stateParams.email);
...
app.controller('PersonCreateController', function ($scope, ContactService, $state, $stateParams) {
	$scope.mode = "Create"
	$scope.contacts = ContactService;
...
app.service('ContactService', function (Contact, $q, toaster, $rootScope) {
	...
	var self = {
		'getPerson': function (emailPerson) {

			self.persons.find(function (element) {
				if (element.email === emailPerson) {
					self.selectedPerson = element;
					return;
				}
			});
